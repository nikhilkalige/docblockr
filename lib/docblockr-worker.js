  ...
  DocBlockrAtom = (function() {
    ...
    function DocBlockrAtom() {
      ...
      atom.workspaceView.command('docblockr:parse-enter', function(event) {
        ...
        else if(self.validate_request(true, regex.snippet_1[0], true, regex.snippet_1[1])) {
        ...
        // Close block comment
        else if(self.validate_request(true, regex.close_block)) {
        ...
        else if(self.validate_request(true, regex.extend_line)) {
