...
module.exports =
  DocBlockrAtom = (function() {
    ...
    DocBlockrAtom.prototype.wrap_lines_command = function() {
      ...
      var spacer_between_sections = (this.editor_settings.spacer_between_sections === 'yes');
      var spacer_between_desc_tags = (this.editor_settings.spacer_between_sections !== 'no');
    ...
    DocBlockrAtom.prototype.create_snippet = function(out) {
      ...
      var i, len;
      if(out) {
        if(this.editor_settings.spacer_between_sections === 'yes') {
          var last_tag = null;
          for(i=0; len = out.length, i < len; i++) {
        ...
        else if(this.editor_settings.spacer_between_sections !== 'no') {
