var Parsers = {
	JsParser: require("./parsers/javascript"),
	CppParser: require("./parsers/cpp"),
	RustParser: require("./parsers/rust"),
	PhpParser: require("./parsers/php"),
	CoffeeParser: require("./parsers/coffee"),
	ActionscriptParser: require("./parsers/actionscript"),
	ObjCParser: require("./parsers/objc"),
	JavaParser: require("./parsers/java"),
	TypescriptParser: require("./parsers/typescript"),
};
...
module.exports =
	DocBlockrAtom = (function () {
		 ...
		 * Used Exclusively with the Parse-Enter command.  So when we press enter, 
		 * 
		 * @returns undefined
		 */
		...
		DocBlockrAtom.prototype.join_command = function () {
			...
			for (i = 0; len = selections.length, i < len; i++) {
				...
				var regex = /[ \t]*\n[ \t]*((?:\*|\/\/[!/]?|#)[ \t]*)?/g;
				// Join the Commented lines into one string instead of multiple lines
