...
module.exports =
	DocBlockrAtom = (function () {
		 ...
		 * Gets settings
		 * Adds a watcher to the settings
		 * Add Commands
		 * Three for Keybindings
		 * 
		 * @returns {undefined}
		 */
		...
		/**
		 * Get a certain start position and and end position
		 * 
		 * @param {any} editor
		 * @param {any} point
		 ...
		 * We then return the parse from the languages folder
		 * @param {any} editor
		 * @returns
		 */
		...
		/**
		 * Used Exclusively with generate_snippet
		 */
