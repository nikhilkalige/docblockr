  ...
  DocBlockrAtom = (function() {
    ...
    function DocBlockrAtom() {
      ...
      atom.commands.add('atom-workspace', 'docblockr:parse-enter', function(event) {
        ...
        // extend line comments (// and # and /// and //!)
        else if((self.editor_settings.extend_double_slash == true) && (self.validate_request({preceding:true, preceding_regex:regex.extend_line, scope:'comment'}))) {
