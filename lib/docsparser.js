...
/**
 * Initialize the Parser Helper Object
 * 
 * @param {any} viewSettings
 */
...
/**
 * Checks to see if we're in the body of a block comment
 * There can only be whitespace and then an asterisk at the beginning of the line
 * 
 * @param {string} line: the contents of the line
 * @returns {boolean} match: is there a match?
 */
